...
//---End AJAX script
client.println("<style>a{color: #77bbff;text-decoration:none;} button {background:#fff;color:#000;}");
client.println(".s{ background: #fff; color: #000; border: 1px solid #333; display: inline-block; text-decoration: none; width:26vw; height:5vw; font-size:4vw; }");
client.println(".s1{ background: #ADFF2F; color: #000; border: 1px solid #333; display: inline-block; text-decoration: none; width:26vw; height:5vw; font-size:4vw; }");
client.println("</style>");
client.println("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"></head>");
client.println("<body style='background:#000;color:#fff;font-family:Arial;font-size:16px;fill:#fff;text-align:center;'>");
